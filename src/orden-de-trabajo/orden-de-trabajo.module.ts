...
@Module({
  imports:[TypeOrmModule.forFeature([SolicitudOrden,EstadoTrabajo,SolicitudDeCompra,EstadoUso,Jornada,Fases,TipoMantenimiento,Periodo,EstadoCompra,MotivosEliminacion]),UsersModule,MailModule],
